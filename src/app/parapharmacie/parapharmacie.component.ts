...
@Component({
  selector: 'app-parapharmacie',
  templateUrl: './parapharmacie.component.html',
  styleUrls: ['./parapharmacie.component.css']
})
export class ParapharmacieComponent implements OnInit {
